...
export default function AppLayout({
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-40 w-64 flex-col overflow-y-auto border-r border-slate-200 bg-white transition-transform lg:static lg:flex lg:translate-x-0",
          mobileOpen
            ? "flex translate-x-0"
